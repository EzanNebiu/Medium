      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_380px]">
        <Card className="space-y-4 p-5">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Field label="Garancia"><Select value={form.warranty} onChange={(e) => setField("warranty", Number(e.target.value))}><option value={0}>Pa garanci</option><option value={6}>6 muaj</option><option value={12}>12 muaj</option><option value={24}>24 muaj</option><option value={36}>36 muaj</option></Select></Field>
